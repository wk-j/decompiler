...
namespace Decompiler.Core {
    ...
    public class Processor {
        ...
        public Output ConvertCsToIl(String csPath) {
            var levels = new[] {
            ...
            foreach (var item in levels) {
                ...
                if (item == OptimizationLevel.Debug) {
                    output.DebugIl = ilPath;
                } else {
                    output.ReleaseIl = ilPath;
                }
            }
            var cakePath = Path.ChangeExtension(csPath, $".Source.cs");
            DecopmileDllToCs(dllPath, cakePath);
            File.Delete(dllPath);
